          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <label
                ...
                className="favorites-filter-label text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wide"
              >
                Category
              </label>
              <select
                ...
                className="favorites-filter-select px-3 py-1.5 rounded-lg text-sm font-medium bg-white dark:bg-slate-700 text-gray-700 dark:text-gray-200 border border-gray-300 dark:border-slate-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
              ...
              <span className="favorites-filter-label ml-2 text-xs font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wide">View</span>
              <button
                type="button"
